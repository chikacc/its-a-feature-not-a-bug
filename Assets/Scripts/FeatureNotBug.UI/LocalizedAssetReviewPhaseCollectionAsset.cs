...
namespace FeatureNotBug.UI {
    [CreateAssetMenu(menuName = "Feature Not Bug/UI/Review Phase Collections/Localized Asset")]
    public sealed class LocalizedAssetReviewPhaseCollectionAsset : VisualTreeCollectionAsset {
